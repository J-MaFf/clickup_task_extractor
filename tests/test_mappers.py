...
class TestExtractImages(unittest.TestCase):
    ...
    def test_direct_url_patterns(self):
        ...
        for url, expected_ext in test_cases:
            ...
            self.assertIn(
                expected_ext, result, f"Failed to extract extension from {url}"
            )
    ...
    def test_attachment_patterns(self):
        ...
        for pattern, expected_ext in test_cases:
            ...
            self.assertIn(
                expected_ext, result, f"Failed to find extension in: {pattern}"
            )
...
class TestGetChoiceInput(unittest.TestCase):
    ...
    @patch("sys.stdout", new_callable=StringIO)
    def test_numeric_input_second_choice(self, mock_stdout, mock_input):
        """Test selecting second choice by number."""
        choices = ["Markdown", "HTML"]
    ...
    def test_invalid_default_index_uses_zero(self, mock_stdout, mock_input):
        ...
        choices = ["Markdown", "HTML"]
        # This should still work and return Markdown (choice 1)
